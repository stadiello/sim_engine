...
public class TileManager {
    ...
    private void loadCityMap() {
        ...
        map = new int[][]{
                ...
                {4,1,1,1,4,0,4,1,1,1,4,0,4,1,1,4},
                {4,1,1,1,4,0,4,1,1,1,4,0,4,1,1,4},
                {4,1,1,1,5,0,5,1,1,1,5,0,5,1,1,4},
                {4,4,4,5,4,0,4,4,4,5,4,0,4,4,4,4},
                {4,1,1,1,4,0,4,1,1,1,4,0,4,1,1,4},
                {4,1,1,1,4,0,4,1,1,1,4,0,4,1,1,4},
                {4,5,1,1,5,0,5,1,1,5,5,0,5,1,5,4},
                {4,1,1,1,4,0,4,1,1,1,4,0,4,1,1,4},
                {4,1,1,1,4,0,4,1,1,1,4,0,4,1,1,4},
                {4,4,4,4,4,0,4,4,4,4,4,0,4,4,4,4},
                {4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4}
        };
    }
